...
class Task(models.Model):
    ...
    owner = models.ForeignKey(User,on_delete=models.SET_NULL,null=True,verbose_name='Owner',related_name='tasks')
...
class SubTask(models.Model):
    ...
    deadline = models.DateTimeField()
    created_at = models.DateTimeField(auto_now_add=True)
    owner = models.ForeignKey(User, on_delete=models.SET_NULL,null=True,verbose_name='Owner',related_name='subtasks')
