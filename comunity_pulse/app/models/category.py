...
class Category(db.Model):
    ...
    name = db.Column(db.String(50),nullable=True, unique=True)  # Поле не должно быть пустым
    questions = db.relationship("Question", back_populates="category", lazy=True,cascade="all, delete-orphan")  # Обратная связь с Question
